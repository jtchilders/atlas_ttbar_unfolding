...
int main(int argc,char** argv){
   ...
   std::cout << " passed unfolding method to use: " << ttbarUnfold::GetMethodString(method) << std::endl;
   std::cout << " syst sample: " << systematicSample.str() << std::endl;
   ...
   if(!analysis.RunMigrationSmearedToys(mc_filename,data_filename,sampleName,nToys,regValue,iterations,histogram2unfold,method)){
      std::cerr << "[main] ERROR in RunMigrationSmearedToys\n";
      return -1;
   }
