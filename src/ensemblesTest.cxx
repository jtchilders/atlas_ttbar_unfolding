...
int main(int argc,char** argv){
   ...
   std::cout << " passed name of the sample to be analysed: " << sample_name << std::endl;
   ...
   //int kreg = atoi(skreg.c_str());
   ttbarUnfoldAnalysis analysis;
   
   if(!analysis.RunOverEnsembleDataSets(mc_files,data_files,sample_name,regValue)){
      std::cerr << "[main] ERROR in RunOverEnsembleDataSets\n";
      return -1;
   }
