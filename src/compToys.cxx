...
int main(int argc,char** argv){
   ...
   std::string mc_filename,data_filename,
               ...
               sampleName, efficiency_filename,efficiency_histoname;
   ...
   std::cout << " passed systematic sample:           " << systematicSample.str() << std::endl;
   ...
   if(!analysis.RunToyUnfolding(mc_filename,data_filename,systematicSample,sampleName,histogram2unfold,method,regValue,iterations,nToys)){
